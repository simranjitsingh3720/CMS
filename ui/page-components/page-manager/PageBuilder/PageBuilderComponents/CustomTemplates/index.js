    ...
    editor.DomComponents.addType('template-modal', {
      view: {
        ...
        onActive(ev) {
          ...
          modal.setTitle('Choose Template');
          container.style.display = 'flex';
          container.style.textAlign = 'center';

          const tempDiv1 = document.createElement('div');
          const template1 = document.createElement('button');
          template1.innerHTML = '<img src="https://my-first-aws-bucket-creation.s3.amazonaws.com/asset/0dd7b23b-77cf-4c8c-856f-38d7974ff436" height=140px width=190px/>';
          template1.className = `${pfx}btn-prim ${pfx}btn-import`;
          template1.style.margin = '20px 20px';
          template1.style.height = '150px';
          template1.style.width = '200px';
          ...
          const tempText1 = document.createElement('div');
          tempText1.innerHTML = 'Basic Template';
          tempDiv1.appendChild(template1);
          tempDiv1.appendChild(tempText1);

          const tempDiv2 = document.createElement('div');
          const template2 = document.createElement('button');
          template2.innerHTML = '<img src="https://my-first-aws-bucket-creation.s3.amazonaws.com/asset/ea7611f5-b88d-4550-bca2-bbedcd87bcbc" height=140px width=190px/>';
          template2.className = `${pfx}btn-prim ${pfx}btn-import`;
          template2.style.margin = '20px 20px';
          template2.style.height = '150px';
          template2.style.width = '200px';
          ...
          const tempText2 = document.createElement('div');
          tempText2.innerHTML = 'Portfolio Template';
          tempDiv2.appendChild(template2);
          tempDiv2.appendChild(tempText2);
